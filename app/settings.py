...
# quando essa contante está recebendo valor `True` é quando está em `ambiente de desenolvimento`
# quando o valor é igual a `False` quer dizer que está em `ambinete de produção`
