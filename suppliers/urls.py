...
urlpatterns = [
    ...
    # URLs APIs
    path('api/v1/supplier', views.SupplierCreateListAPIView.as_view(), name='supplier-create-api-view'),
    path('api/v1/supplier/<int:pk>', views.SupplierRetrieveUpdateDestroyAPIView.as_view(), name='supplier-create-api-view'),
]
